...
var Zepto = function() {
	...
	return G.matches = function(t, e) {
		...
		var i, r, a;
		return F.test(t) && (i = S(k.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(R, "<$1></$2>")), e === T && (e = $.test(t) && RegExp.$1), e in V || (e = "*"), a = V[e], a.innerHTML = "" + t, i = S.each(M.call(a.childNodes), function() {
			a.removeChild(this)
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	function(t) {
		...
		j.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
			...
			if(p && p.promise(C), u.crossDomain || T("X-Requested-With", "XMLHttpRequest"), T("Accept", w || "*/*"), (w = u.mimeType || w) && (w.indexOf(",") > -1 && (w = w.split(",", 2)[0]), C.overrideMimeType && C.overrideMimeType(w)), (u.contentType || u.contentType !== !1 && u.data && "GET" != u.type.toUpperCase()) && T("Content-Type", u.contentType || "application/x-www-form-urlencoded"), u.headers)
			...
			if(C.setRequestHeader = T, C.onreadystatechange = function() {
					if(4 == C.readyState) {
						...
						if(C.status >= 200 && C.status < 300 || 304 == C.status || 0 == C.status && "file:" == E) {
							if(d = d || l(u.mimeType || C.getResponseHeader("content-type")), "arraybuffer" == C.responseType || "blob" == C.responseType) e = C.response;
							else {
								e = C.responseText;
								try {
	...
	function(t, e) {
		...
		t.each(m, function(t, n) {
			...
			var b, w, x, T = {},
				...
				C = !1;
			if(r === e && (r = t.fx.speeds._default / 1e3), g === e && (g = 0), t.fx.off && (r = 0), "string" == typeof i) T[l] = i, T[f] = r + "s", T[p] = g + "s", T[h] = d || "linear", j = t.fx.animationEnd;
			else {
				w = [];
				for(b in i) v.test(b) ? E += b + "(" + i[b] + ") " : (T[b] = i[b], w.push(n(b)));
			...
			return x = function(e) {
				...
				C || x.call(S)
			}, 1e3 * (r + g) + 25)), this.size() && this.get(0).clientLeft, this.css(T), 0 >= r && setTimeout(function() {
				S.each(function() {
					x.call(this)
				})
			}, 0), this
